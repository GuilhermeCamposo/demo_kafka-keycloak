...
You can add more users to the groups and roles used in the demo. A LDAP server is provioned during the installation. Check the link:https://hub.docker.com/r/bitnami/openldap/[image documentation, window="_blank"] for information about passwords and default data.


First step is to add a new User Federation LDAP provider. Here is what you should input in the form:
